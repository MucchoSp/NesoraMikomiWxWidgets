...
void nsPhoneticLFModelPanel::Init() {
    ...
    pitch_slider->Bind(wxEVT_COMMAND_SLIDER_UPDATED, &nsPhoneticLFModelPanel::OnPitchSlide, this);
    ...
    phonetic_slider->Bind(wxEVT_COMMAND_SLIDER_UPDATED, &nsPhoneticLFModelPanel::OnPhoneticSlide, this);
    ...
    tpslider->Bind(wxEVT_COMMAND_SLIDER_UPDATED, &nsPhoneticLFModelPanel::OnTpSlide, this);
    ...
    teslider->Bind(wxEVT_COMMAND_SLIDER_UPDATED, &nsPhoneticLFModelPanel::OnTeSlide, this);
    ...
    taslider->Bind(wxEVT_COMMAND_SLIDER_UPDATED, &nsPhoneticLFModelPanel::OnTaSlide, this);
    ...
    eeslider->Bind(wxEVT_COMMAND_SLIDER_UPDATED, &nsPhoneticLFModelPanel::OnEeSlide, this);
...
void nsPhoneticLFModelPanel::Update() {
    // TODO: パラメータの更新
}
...
void nsPhoneticLFModelPanel::OnPhoneticSlide(wxCommandEvent& event) {
    phonetic_param->SetLabel(to_string_with_precision((double)phonetic_slider->GetValue() / 1000.0, 3) + " Hz");

    UpdateChart();
}

void nsPhoneticLFModelPanel::OnTpSlide(wxCommandEvent& event) {
...
void nsPhoneticLFModelPanel::OnTeSlide(wxCommandEvent& event) {
    teparam->SetLabel("Te: " + to_string_with_precision((double)teslider->GetValue() / 1000.0, 3));
...
void nsPhoneticLFModelPanel::OnTaSlide(wxCommandEvent& event) {
    taparam->SetLabel("Ta: " + to_string_with_precision((double)taslider->GetValue() / 1000.0, 3));

    UpdateChart();
}

void nsPhoneticLFModelPanel::OnEeSlide(wxCommandEvent& event) {
    eeparam->SetLabel("Ee: " + to_string_with_precision((double)eeslider->GetValue() / 1000.0, 3));

    UpdateChart();
}

void nsPhoneticLFModelPanel::UpdateChart() {
...
std::vector<double> nsPhoneticLFModelPanel::GetWave() const {
    return wave;
}

NesoraSourceBase* nsPhoneticLFModelPanel::GetSource() {
    return source_wave;
}

double nsPhoneticLFModelPanel::GetPitch() const {
...
// MARK: nsPhoneticLFModelRdParameterPanel

void nsPhoneticLFModelRdParameterPanel::Init() {
    SetBackgroundColour(nsGetColor(nsColorType::BACKGROUND));
    ...
    pitch_sliderSizer->Add(pitch_param, 0, wxEXPAND | wxALL, 5);
    pitch_slider = new nsSlider(sourceSizer->GetStaticBox(), wxID_ANY, 261, 20, 1000, wxDefaultPosition, wxSize(200, 15));
    pitch_slider->Bind(wxEVT_COMMAND_SLIDER_UPDATED, &nsPhoneticLFModelRdParameterPanel::OnPitchSlide, this);
    pitch_slider->Show();
    pitch_sliderSizer->Add(pitch_slider, 1, wxEXPAND | wxALL, 5);
    sliderSizer->Add(pitch_sliderSizer, 0, wxEXPAND | wxALL);
    ...
    phonetic_sliderSizer->Add(phonetic_param, 0, wxEXPAND | wxALL, 5);
    phonetic_slider = new nsSlider(sourceSizer->GetStaticBox(), wxID_ANY, 100, 0, 1000, wxDefaultPosition, wxSize(200, 15));
    phonetic_slider->Bind(wxEVT_COMMAND_SLIDER_UPDATED, &nsPhoneticLFModelRdParameterPanel::OnPhoneticSlide, this);
    phonetic_slider->Show();
    phonetic_sliderSizer->Add(phonetic_slider, 1, wxEXPAND | wxALL, 5);
    sliderSizer->Add(phonetic_sliderSizer, 0, wxEXPAND | wxALL);
    ...
    rdslider->Bind(wxEVT_COMMAND_SLIDER_UPDATED, &nsPhoneticLFModelRdParameterPanel::OnRdSlide, this);
    rdslider->Show();
    ...
    ee_sliderSizer->Add(eeparam, 0, wxEXPAND | wxALL, 5);
    eeslider = new nsSlider(sourceSizer->GetStaticBox(), wxID_ANY, 1000, 1, 1000, wxDefaultPosition, wxSize(200, 15));
    eeslider->Bind(wxEVT_COMMAND_SLIDER_UPDATED, &nsPhoneticLFModelRdParameterPanel::OnEeSlide, this);
    eeslider->Show();
    ee_sliderSizer->Add(eeslider, 1, wxEXPAND | wxALL, 5);
    sliderSizer->Add(ee_sliderSizer, 0, wxEXPAND | wxALL);
...
void nsPhoneticLFModelRdParameterPanel::Update() {
    // TODO: パラメータの更新
}
...
void nsPhoneticLFModelRdParameterPanel::OnPhoneticSlide(wxCommandEvent& event) {
    phonetic_param->SetLabel(to_string_with_precision((double)phonetic_slider->GetValue() / 1000.0, 3) + " Hz");

    UpdateChart();
}

void nsPhoneticLFModelRdParameterPanel::OnRdSlide(wxCommandEvent& event) {
    rdparam->SetLabel("Rd: " + to_string_with_precision((double)rdslider->GetValue() / 1000.0, 3));

    UpdateChart();
}

void nsPhoneticLFModelRdParameterPanel::OnEeSlide(wxCommandEvent& event) {
    eeparam->SetLabel("Ee: " + to_string_with_precision((double)eeslider->GetValue() / 1000.0, 3));

    UpdateChart();
}

void nsPhoneticLFModelRdParameterPanel::UpdateChart() {
...
std::vector<double> nsPhoneticLFModelRdParameterPanel::GetWave() const {
    return wave;
}

NesoraSourceBase* nsPhoneticLFModelRdParameterPanel::GetSource() {
    return source_wave;
}

double nsPhoneticLFModelRdParameterPanel::GetPitch() const {
    return (double)pitch_slider->GetValue();
}
