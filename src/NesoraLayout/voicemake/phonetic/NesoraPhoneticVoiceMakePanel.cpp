...
#include "NesoraPhoneticVoiceMakePanel.h"
...
void nsPhoneticVoiceMakePlayInterfacePanel::Init() {
    ...
    volume->Bind(wxEVT_COMMAND_SLIDER_UPDATED, &nsPhoneticVoiceMakePlayInterfacePanel::OnVolumeSlide, this);
...
void nsPhoneticVoiceMakePlayInterfacePanel::OnVolumeSlide(wxCommandEvent& event) {
...
void nsPhoneticVoiceMakePanel::Init() {
    SetBackgroundColour(nsGetColor(nsColorType::BACKGROUND));
    ...
    playInterfacePanel = new nsPhoneticVoiceMakePlayInterfacePanel(this, wxID_ANY);
    ...
    playInterfacePanel->playButton->Bind(wxEVT_BUTTON, &nsPhoneticVoiceMakePanel::OnPlayButtonClicked, this);
    playInterfacePanel->stopButton->Bind(wxEVT_BUTTON, &nsPhoneticVoiceMakePanel::OnStopButtonClicked, this);
}


void nsPhoneticVoiceMakePanel::OnPlayButtonClicked(wxCommandEvent& event) {
    InitAudioDevice();
}

void nsPhoneticVoiceMakePanel::OnStopButtonClicked(wxCommandEvent& event) {
    UninitAudioDevice();
}


void nsPhoneticVoiceMakePanel::InitAudioDevice() {
    if (isPlaying) {
        return;
    }
    isPlaying = true;
    ...
    deviceConfig.dataCallback = nsPhoneticVoiceMakePanel::data_callback;
...
void nsPhoneticVoiceMakePanel::UninitAudioDevice() {
    isPlaying = false;
    ma_device_uninit(&device);
}

void nsPhoneticVoiceMakePanel::data_callback(ma_device* pDevice, void* pOutput, const void* pInput, ma_uint32 frameCount) {
...
void nsPhoneticVoiceMakePanel::OnSave(wxCommandEvent& event) {
...
void nsPhoneticVoiceMakePanel::OnOpen(wxCommandEvent& event) {
...
void nsPhoneticVoiceMakePanel::PanelEnable() {
    Show();
    menuSetup();
}

void nsPhoneticVoiceMakePanel::PanelDisable() {
    Hide();
}

void nsPhoneticVoiceMakePanel::menuSetup() {
    // nsID_MAIN_FRAME
    ...
    mainFrame->Bind(wxEVT_MENU, &nsPhoneticVoiceMakePanel::OnSave, this, wxID_SAVE);
    mainFrame->Bind(wxEVT_MENU, &nsPhoneticVoiceMakePanel::OnOpen, this, wxID_OPEN);
}
