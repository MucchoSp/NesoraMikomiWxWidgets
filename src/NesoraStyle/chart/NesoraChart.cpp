...
void nsChartControl::OnPaint(wxPaintEvent& event) {
    ...
    if (gc && m_data.size() > 0) {
        ...
        gc->SetFont(*wxNORMAL_FONT, nsGetColor(nsColorType::ON_BACKGROUND));
